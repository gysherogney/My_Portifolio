...
<head>
    ...
    <title>Neema- Personal Portfolio Template</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="intro-caption">
                                <span>I am Neema Kamugisha</span>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="content-left">
                            ...
                            <div class="content">
                                <h2>I am a System Developer</h2>
                                <p> Based on developing different System using different languages especially WEB DEVELOPMENT</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="content-left">
                                    <div class="title-resume">
                                        <h2>Experience</h2>
                                        <h3>More than 2 years experience as a <span>System Developer</span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="content-right">
                                    <ul class="timeline">
                                        <li>
                                            ...
                                            <span>System Development (2019 - 2021)</span>
                                        </li>
                                        <li>
                                            <h4>Data Analyst</h4>
                                            <span>System Development(2019 - 2021)</span>
                                        ...
                                        <li>
                                            ...
                                            <span>Database Administration(2019 - 2021)</span>
                                        </li>
                        ...
                        <div class="row ">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="content-left">
                                    <div class="title-resume">
                                        <h2>Education</h2>
                                        <h3>Learning experience in a few <span>Professional Universities</span></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="content-right">
                                    <ul class="timeline">
                                        <li>
                                            <h4>UDOM University</h4>
                                            <span>Diploma in Computer science (2019 - 2021)</span>
                                        </li>
                                        <li>
                                            <h4>UDOM University</h4>
                                            <span>Degree in Computer Science(2012 - 2015)</span>
                                        </li>
                            ...
                            <div class="row ">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="content-left">
                                        <div class="title-resume">
                                            <h2>Skill</h2>
                                            <h3>With good <span>Personal</span> and <span>Professional Skills</span></h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="portfolio-filter-menu">
                     ...
                     <div class="row"> 
                        <div class="column> 
                            ...
                            <img src="{{ asset('/images/'.$myPhoto->Photos) }}"   width="320px" height="320px" alt="image">
        ...
        <div class="container">
            <div class="box-content">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="content-right">
                    <form action="{{  url('/repeat') }}" method="POST" class="contact-form" >
                              @csrf
                              <div class="row">
                                <div class="col">
                ...
                <div id="last-name-field">
                                    ...
                                    <div class="col">
                                        <div id="message-field">
                                            <textarea cols="30" rows="5"  name="message" placeholder="Message" class="form-control" id="form-message"></textarea>
                                        </div>
                                    </div>
                                </div>
                                
                                <button type="submit"  value="send message" class="button" id="submit">send message</button>
                            </form>
